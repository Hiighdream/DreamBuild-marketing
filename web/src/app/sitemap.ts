...
import { SHOW_RESOURCES, SITE_URL } from "@/lib/site";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    // /resources is excluded while the section is hidden (see SHOW_RESOURCES).
    ...(SHOW_RESOURCES
      ? [{ url: `${SITE_URL}/resources`, changeFrequency: "weekly" as const, priority: 0.8 }]
      : []),
  ...
  const publishedArticleRoutes: MetadataRoute.Sitemap = SHOW_RESOURCES
    ? getAllArticles()
